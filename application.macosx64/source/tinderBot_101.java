...
public class tinderBot_101 extends PApplet {
...
public void analysedImage() {
  ...
  for (int i = 0; i < faces.length; i++) {
    ...
    fill(255);
    String display = "Age: " + PApplet.parseInt(faces[i].age) + "\n\n";                        // Age
...
public void runCreatePhotoPostWithImageFileChoreo() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "tinderBot_101" };
    if (passedArgs != null) {
